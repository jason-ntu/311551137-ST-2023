...
Disclaimer: The following 4 examples are automatically generated by chatGPT3.
...
```
=================================================================
==2493==ERROR: AddressSanitizer: stack-use-after-return on address 0x7fa30316b021 at pc 0x55b89dbd0333 bp 0x7ffeab3094d0 sp 0x7ffeab3094c0
WRITE of size 1 at 0x7fa30316b021 thread T0
    #0 0x55b89dbd0332 in main (/workspaces/311551137-ST-2023/Lab06/a.out+0x1332)
    #1 0x7fa30690bd8f in __libc_start_call_main ../sysdeps/nptl/libc_start_call_main.h:58
    #2 0x7fa30690be3f in __libc_start_main_impl ../csu/libc-start.c:392
    #3 0x55b89dbd0144 in _start (/workspaces/311551137-ST-2023/Lab06/a.out+0x1144)

Address 0x7fa30316b021 is located in stack of thread T0 at offset 33 in frame
    #0 0x55b89dbd0218 in foo (/workspaces/311551137-ST-2023/Lab06/a.out+0x1218)

  This frame has 1 object(s):
    [32, 35) 'stack_buffer' (line 7) <== Memory access at offset 33 is inside this variable
HINT: this may be a false positive if your program uses some custom stack unwind mechanism, swapcontext or vfork
      (longjmp and C++ exceptions *are* supported)
SUMMARY: AddressSanitizer: stack-use-after-return (/workspaces/311551137-ST-2023/Lab06/a.out+0x1332) in main
Shadow bytes around the buggy address:
  0x0ff4e06255b0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
  0x0ff4e06255c0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
  0x0ff4e06255d0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
  0x0ff4e06255e0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
  0x0ff4e06255f0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
=>0x0ff4e0625600: f5 f5 f5 f5[f5]f5 f5 f5 00 00 00 00 00 00 00 00
  0x0ff4e0625610: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
  0x0ff4e0625620: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
  0x0ff4e0625630: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
  0x0ff4e0625640: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
  0x0ff4e0625650: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
Shadow byte legend (one shadow byte represents 8 application bytes):
  Addressable:           00
  Partially addressable: 01 02 03 04 05 06 07 
  Heap left redzone:       fa
...
==1030== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==1030== Using Valgrind-3.18.1 and LibVEX; rerun with -h for copyright info
==1030== Command: ./a.out
==1030== 
==1030== 
==1030== HEAP SUMMARY:
==1030==     in use at exit: 0 bytes in 0 blocks
==1030==   total heap usage: 0 allocs, 0 frees, 0 bytes allocated
==1030== 
==1030== All heap blocks were freed -- no leaks are possible
==1030== 
==1030== For lists of detected and suppressed errors, rerun with: -s
